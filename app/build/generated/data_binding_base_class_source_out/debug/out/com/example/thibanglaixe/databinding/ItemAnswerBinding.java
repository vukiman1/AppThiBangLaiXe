...
public final class ItemAnswerBinding implements ViewBinding {
  ...
  private ItemAnswerBinding(@NonNull LinearLayout rootView, @NonNull TextView textAnswer,
  ...
  public static ItemAnswerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAnswerBinding((LinearLayout) rootView, textAnswer, textNumber);
    }
